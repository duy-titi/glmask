...
const WebARRocksFaceThreeHelper = (function(){
  ...
  function update_focals(){
    ...
    console.log('INFO in WebARRocksFaceThreeHelper - focal =', fy);
  ...
  function compute_pose(landmarks, faceSlot){
    ...
    _computePose.imgPointsLMIndices.forEach(function(ind, i){
      ...
      //if (landmarks[ind]===undefined) debugger;
    ...
    if (solved){
	  ...
	  console.log(faceSlot.faceFollowerParent.rotation);
	  console.log('scale:');
	  console.log(faceSlot.faceFollowerParent.scale);
      if (_spec.isCenterObjPoints){
